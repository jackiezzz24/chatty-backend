...
import { blockedUserQueue } from '@service/queues/blocked-user.queue';
...
export class AddUser {
  ...
  public async updateBlockedUser(followerId: string, userId: string, type: 'block' | 'unblock'): Promise<void> {
